...
const { createServer, appLog, sendJson, createRoute, auth: gbAuth } = require("./core/index.js");
...
gbAuth.init({ sessionFile: require("./store/json-dir.js").jsonFile("sessions.json"), cookieName: "gbmd_session" });
gbAuth.startCleanup();
